...
public class ImagesGridFragment extends Fragment implements OnImagesLoadedListener, AndroidImagePicker.OnImageSelectedChangeListener, AndroidImagePicker.OnImageCropCompleteListener {
    ...
    public static ImagesGridFragment newInstance(String param, Boolean onlyCamera) {
        ImagesGridFragment fragment = new ImagesGridFragment();
        Bundle args = new Bundle();
        args.putString("themeColor", param);
        args.putBoolean("onlyCamera", onlyCamera);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        onlyCamera = getArguments().getBoolean("onlyCamera");
                        ...
                        if (androidImagePicker.getSelectImageCount() > androidImagePicker.getSelectLimit()) {
                            if (holder.cbSelected.isChecked()) {
                                ...
                                Toast.makeText(mContext,
                                        getResources().getString(R.string.you_have_a_select_limit)
                                                + androidImagePicker.getSelectLimit()
                                                + getResources().getString(R.string.piece)
                                                + getResources().getString(R.string.image), Toast.LENGTH_SHORT).show();
                            } else {
                                //
                            }
                        } else {
