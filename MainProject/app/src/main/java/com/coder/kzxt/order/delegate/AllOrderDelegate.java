...
/**
 * 全部订单delegate
 * Created by wangtignshun on 2017/4/13.
 */
public class AllOrderDelegate extends PullRefreshDelegate<MyOrderBean.OrderBean> {

    private Context mContext;

    public AllOrderDelegate(Context context) {
    ...
    public void initCustomView(BaseViewHolder holder, List<MyOrderBean.OrderBean> data, int position) {
        ...
        RelativeLayout contentItem = holder.findViewById(R.id.rl_content);  //订单item
        ...
        Utils.setPrice(coursePrice, orderBean.getCourse_class().getPrice());  //课程价格暂时根据班级走
        ...
        if (orderListener != null) {
            cancleOrder.setOnClickListener(new View.OnClickListener() { //取消订单
                ...
                public void onClick(View view) {
                    orderListener.onOrderCancle(orderBean, AllOrderDelegate.this);
                }
            });
