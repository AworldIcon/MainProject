 ...
 * 我的课程
 */
public class MainMyCourseAdapter {
    ...
    private static final String
            STUDENT_HENG_FOUR_1 = "STUDENT_HENG_FOUR_1", STUDENT_HENG_FOUR_2 = "STUDENT_HENG_FOUR_2",
            STUDENT_SHU_TWO_1 = "STUDENT_SHU_TWO_1", STUDENT_SHU_TWO_2 = "STUDENT_SHU_TWO_2",
            STUDENT_SHANGTUO_TWO_1 = "STUDENT_SHANGTUO_TWO_1", STUDENT_SHANGTUO_TWO_2 = "STUDENT_SHANGTUO_TWO_2",
            STUDENT_HENGXIANG_TWO_1 = "STUDENT_HENGXIANG_TWO_1", STUDENT_HENGXIANG_TWO_2 = "STUDENT_HENGXIANG_TWO_2",
            STUDENT_SHUONE_HENGTWO_1 = "STUDENT_SHUONE_HENGTWO_1", STUDENT_SHUONE_HENGTWO_2 = "STUDENT_SHUONE_HENGTWO_2",
            STUDENT_SHUONE_HENGTWO_XIAHENGONE_1 = "STUDENT_SHUONE_HENGTWO_XIAHENGONE_1", STUDENT_SHUONE_HENGTWO_XIAHENGONE_2 = "STUDENT_SHUONE_HENGTWO_XIAHENGONE_2",
            STUDENT_SHUONE_HENGTWO_XIASHUTWO_1 = "STUDENT_SHUONE_HENGTWO_XIASHUTWO_1", STUDENT_SHUONE_HENGTWO_XIASHUTWO_2 = "STUDENT_SHUONE_HENGTWO_XIASHUTWO_2",
            STUDENT_ZHENGFOUR_XIAHENGONE_1 = "STUDENT_ZHENGFOUR_XIAHENGONE_1", STUDENT_ZHENGFOUR_XIAHENGONE_2 = "STUDENT_ZHENGFOUR_XIAHENGONE_2";

    /**
     * 需要显示老师名称和学习人数的
     */
    public static String showTeacherAndNumber = STUDENT_HENG_FOUR_1 + "," + STUDENT_SHU_TWO_1 + "," + STUDENT_SHANGTUO_TWO_1 + "," +
            STUDENT_HENGXIANG_TWO_1 + "," + STUDENT_SHUONE_HENGTWO_1 + "," + STUDENT_SHUONE_HENGTWO_XIAHENGONE_1 + "," +
            STUDENT_SHUONE_HENGTWO_XIASHUTWO_1 + "," + STUDENT_ZHENGFOUR_XIAHENGONE_1;


    public static String types = STUDENT_HENG_FOUR_1 + "," + STUDENT_HENG_FOUR_2 + "," + STUDENT_SHU_TWO_1 + "," + STUDENT_SHU_TWO_2 + "," + STUDENT_SHANGTUO_TWO_1 + "," + STUDENT_SHANGTUO_TWO_2 + "," +
            STUDENT_HENGXIANG_TWO_1 + "," + STUDENT_HENGXIANG_TWO_2 + "," + STUDENT_SHUONE_HENGTWO_1 + "," + STUDENT_SHUONE_HENGTWO_2 + "," +
            "" + STUDENT_SHUONE_HENGTWO_XIAHENGONE_1 + "," + STUDENT_SHUONE_HENGTWO_XIAHENGONE_2 + "," +
            STUDENT_SHUONE_HENGTWO_XIASHUTWO_1 + "," + STUDENT_SHUONE_HENGTWO_XIASHUTWO_2 + "," + STUDENT_ZHENGFOUR_XIAHENGONE_1 + "," + STUDENT_ZHENGFOUR_XIAHENGONE_2;


    public MainMyCourseAdapter(Activity mContext, MainModelBean.ItemsBean moduleType, List<MainModelBean.ItemsBean.ListBean> data) {
        super();
    ...
    public View getView() {
        ...
        switch (configBean.getModule_style()) {
            case STUDENT_HENG_FOUR_1:
                view = disPlayGridView(view);
                break;
            case STUDENT_HENG_FOUR_2:
                view = disPlayGridView(view);
                break;
            case STUDENT_SHU_TWO_1:
                view = disPlayListView(view, 2);
                break;
            case STUDENT_SHU_TWO_2:
                view = disPlayListView(view, 2);
                break;
            case STUDENT_SHANGTUO_TWO_1:
                view = setListViewGridView(view, 2);
                break;
            case STUDENT_SHANGTUO_TWO_2:
                view = setListViewGridView(view, 2);
                break;
            case STUDENT_HENGXIANG_TWO_1:
                view = disPlayListView(view, 1);
                break;
            case STUDENT_HENGXIANG_TWO_2:
                view = disPlayListView(view, 1);
                break;
            //不规则
            case STUDENT_SHUONE_HENGTWO_1:
                view = setListViewThreeItem(view);
                break;
            case STUDENT_SHUONE_HENGTWO_2:
                view = setListViewThreeItem(view);
                break;
            case STUDENT_SHUONE_HENGTWO_XIAHENGONE_1:
                view = setListViewListView(view);
                break;
            case STUDENT_SHUONE_HENGTWO_XIAHENGONE_2:
                view = setListViewListView(view);
                break;
            case STUDENT_SHUONE_HENGTWO_XIASHUTWO_1:
                view = setGridViewThreeItem(view);
                break;
            case STUDENT_SHUONE_HENGTWO_XIASHUTWO_2:
                view = setGridViewThreeItem(view);
                break;
            case STUDENT_ZHENGFOUR_XIAHENGONE_1:
                view = setListViewGridView(view, 4);
                break;
            case STUDENT_ZHENGFOUR_XIAHENGONE_2:
                view = setListViewGridView(view, 4);
                break;
            default:
                view = disPlayListView(view, 1);
        ...
        loadMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                           Intent intent = new Intent(mContext, LearnCourseActivity.class);
