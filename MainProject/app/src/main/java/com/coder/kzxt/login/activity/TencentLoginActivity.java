 ...
 * 手机注册
 */
public class TencentLoginActivity extends BaseActivity implements HttpCallBack {
    ...
    private void initListener() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(phone_email)) {
                    ...
                    ToastUtils.makeText(TencentLoginActivity.this, getResources().getString(R.string.phone_num_limit), Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    //判断手机号并获取验证码，获取成功进入下一页
                    if(checkBox.isChecked()){
                        if(ValidatorUtil.isMobile(phone_email)){
                            dialog = MyPublicDialog.createLoadingDialog(TencentLoginActivity.this);
                            dialog.show();
                            getUserList();
                        } else {
                            ToastUtils.makeText(TencentLoginActivity.this, getResources().getString(R.string.phone_legal_number), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
        ...
        change_to_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(TencentLoginActivity.this, BindSelfAccountActivity.class);
...
//        }
    ...
    private void jumpNextActivity() {
        Intent intent=new Intent();
        intent.setClass(TencentLoginActivity.this,CheckCodeActivity.class);
        intent.putExtra("from","registerbyphone");
        intent.putExtra("isTencent",1);
        intent.putExtra("oauthType",type);
    ...
    private void errorProcess(String msg) {
        if (!TextUtils.isEmpty(msg)) {
            Toast.makeText(TencentLoginActivity.this, msg, Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(TencentLoginActivity.this, getResources().getString(R.string.net_inAvailable), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void setOnErrorCallback(int requestCode, int code, String msg) {
        if (requestCode == Constants.HTTP_CODE_4000 ||
            ...
            if (!NetworkUtil.isNetworkAvailable(this)) {
                NetworkUtil.httpNetErrTip(TencentLoginActivity.this, myLayout);
            } else {
                //其他处理
            }
        } else {
