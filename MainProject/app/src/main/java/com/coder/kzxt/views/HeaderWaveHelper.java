...
public class HeaderWaveHelper {
    ...
    private float mDefaultWaterLevelRatioF = 0.85f;
    private float mDefaultWaterLevelRatioT = 0.85f;
    //波浪大小振幅 amplitudeRatio
    private float mDefaultAmplitudeRatioF = 0.06f;
    private float mDefaultAmplitudeRatioT = 0.06f;
    //floatView 旋转调整角
    ...
    public void start() {
        ...
        if (mAnimatorSet != null && !mHasStart) {
            ...
            if (amplitudeChangeAnim != null) {
                ...
                amplitudeChangeAnim.setDuration(1500);
    ...
    public void cancel() {
        if (mAnimatorSet != null && !mHasCancel) {
            ...
            amplitudeChangeAnim.setDuration(2000);
            amplitudeChangeAnim.start();
