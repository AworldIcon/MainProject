...
public class ScrollHeaderListView extends ExpandableListView implements OnScrollListener,OnGroupClickListener {
	
	public ScrollHeaderListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public ScrollHeaderListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public ScrollHeaderListView(Context context) {
		super(context);
		registerListener();
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		return flag?flag:super.onTouchEvent(ev);
	}
