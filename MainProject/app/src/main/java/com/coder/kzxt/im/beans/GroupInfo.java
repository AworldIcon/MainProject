...
public class GroupInfo implements Observer
{
    ...
    public static String getTypeName(String type){
        if (type.equals(GroupInfo.publicGroup)){
            return MyApplication.getInstance().getApplicationContext().getString(R.string.public_group);
        }else if (type.equals(GroupInfo.privateGroup)){
            return MyApplication.getInstance().getApplicationContext().getString(R.string.discuss_group);
        }else if (type.equals(GroupInfo.chatRoom)){
            return MyApplication.getInstance().getApplicationContext().getString(R.string.chatroom);
        }
        return "";
    }
