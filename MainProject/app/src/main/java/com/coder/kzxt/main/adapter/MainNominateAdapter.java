...
public class MainNominateAdapter {
    ...
    private static final String
            NOMINATE_ZHENG_FOUR_1 = "NOMINATE_ZHENG_FOUR_1", NOMINATE_ZHENG_FOUR_2 = "NOMINATE_ZHENG_FOUR_2",
            NOMINATE_SHU_TWO_1 = "NOMINATE_SHU_TWO_1", NOMINATE_SHU_TWO_2 = "NOMINATE_SHU_TWO_2",
            NOMINATE_SHANGTUO_TWO_1 = "NOMINATE_SHANGTUO_TWO_1", NOMINATE_SHANGTUO_TWO_2 = "NOMINATE_SHANGTUO_TWO_2",
            NOMINATE_HENGXIANG_TWO_1 = "NOMINATE_HENGXIANG_TWO_1", NOMINATE_HENGXIANG_TWO_2 = "NOMINATE_HENGXIANG_TWO_2",
            NOMINATE_SHUONE_HENGTWO_1 = "NOMINATE_SHUONE_HENGTWO_1", NOMINATE_SHUONE_HENGTWO_2 = "NOMINATE_SHUONE_HENGTWO_2",
            NOMINATE_SHUONE_HENGTWO_XIAHENGONE_1 = "NOMINATE_SHUONE_HENGTWO_XIAHENGONE_1", NOMINATE_SHUONE_HENGTWO_XIAHENGONE_2 = "NOMINATE_SHUONE_HENGTWO_XIAHENGONE_2",
            NOMINATE_SHUONE_HENGTWO_XIASHUTWO_1 = "NOMINATE_SHUONE_HENGTWO_XIASHUTWO_1", NOMINATE_SHUONE_HENGTWO_XIASHUTWO_2 = "NOMINATE_SHUONE_HENGTWO_XIASHUTWO_2",
            NOMINATE_ZHENGFOUR_XIAHENGONE_1 = "NOMINATE_ZHENGFOUR_XIAHENGONE_1", NOMINATE_ZHENGFOUR_XIAHENGONE_2 = "NOMINATE_ZHENGFOUR_XIAHENGONE_2";
    /**
     * 需要显示老师名称和学习人数的
     */
    public static String showTeacherAndNumber = NOMINATE_ZHENG_FOUR_1 + "," + NOMINATE_SHU_TWO_1 + "," + NOMINATE_SHANGTUO_TWO_1 + "," +
            NOMINATE_HENGXIANG_TWO_1 + "," + NOMINATE_SHUONE_HENGTWO_1 + "," + NOMINATE_SHUONE_HENGTWO_XIAHENGONE_1 + "," +
            NOMINATE_SHUONE_HENGTWO_XIASHUTWO_1 + "," + NOMINATE_ZHENGFOUR_XIAHENGONE_1;


    public static String types = NOMINATE_ZHENG_FOUR_1 + "," + NOMINATE_ZHENG_FOUR_2 + "," + NOMINATE_SHU_TWO_1 + "," + NOMINATE_SHU_TWO_2 + "," + NOMINATE_SHANGTUO_TWO_1 + "," + NOMINATE_SHANGTUO_TWO_2 + "," +
            NOMINATE_HENGXIANG_TWO_1 + "," + NOMINATE_HENGXIANG_TWO_2 + "," + NOMINATE_SHUONE_HENGTWO_1 + "," + NOMINATE_SHUONE_HENGTWO_2 + "," +
            "" + NOMINATE_SHUONE_HENGTWO_XIAHENGONE_1 + "," + NOMINATE_SHUONE_HENGTWO_XIAHENGONE_2 + "," +
    ...
    public MainNominateAdapter(Activity mContext, MainModelBean.ItemsBean moduleType, List<MainModelBean.ItemsBean.ListBean> data) {
        super();
        this.mContext = mContext;
        this.data = data;
        //his.pu = new PublicUtils(this.mContext);
    ...
    public View getView() {
        ...
        switch (configBean.getModule_style()) {
            case NOMINATE_ZHENG_FOUR_1:
                view = disPlayGridView(view);
                break;
            case NOMINATE_ZHENG_FOUR_2:
                view = disPlayGridView(view);
                break;
            case NOMINATE_SHU_TWO_1:
                view = disPlayListView(view, 2);
                break;
            case NOMINATE_SHU_TWO_2:
                view = disPlayListView(view, 2);
                break;
            case NOMINATE_SHANGTUO_TWO_1:
                view = setListViewGridView(view, 2);
                break;
            case NOMINATE_SHANGTUO_TWO_2:
                view = setListViewGridView(view, 2);
                break;
            case NOMINATE_HENGXIANG_TWO_1:
                view = disPlayListView(view, 1);
                break;
            case NOMINATE_HENGXIANG_TWO_2:
                view = disPlayListView(view, 1);
                break;
            //不规则
            case NOMINATE_SHUONE_HENGTWO_1:
                view = setListViewThreeItem(view);
                break;
            case NOMINATE_SHUONE_HENGTWO_2:
                view = setListViewThreeItem(view);
                break;
            case NOMINATE_SHUONE_HENGTWO_XIAHENGONE_1:
                view = setListViewListView(view);
                break;
            case NOMINATE_SHUONE_HENGTWO_XIAHENGONE_2:
                view = setListViewListView(view);
                break;
            case NOMINATE_SHUONE_HENGTWO_XIASHUTWO_1:
                view = setGridViewThreeItem(view);
                break;
            case NOMINATE_SHUONE_HENGTWO_XIASHUTWO_2:
                view = setGridViewThreeItem(view);
                break;
            case NOMINATE_ZHENGFOUR_XIAHENGONE_1:
                view = setListViewGridView(view, 4);
                break;
            case NOMINATE_ZHENGFOUR_XIAHENGONE_2:
                view = setListViewGridView(view, 4);
                break;
            default:
                view = disPlayListView(view, 1);
        ...
        loadMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // mContext.startActivity(new Intent(mContext, LocalCourseListActivity.class).putExtra("title",configBean.getModuleName()).putExtra("type",LocalCourseListActivity.QUALITY_COURSELIST));
            }
        });
        return view;
    }
