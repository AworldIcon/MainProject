...
public class ClassGambitDelegate extends PullRefreshDelegate<GambitEntity>
{

    private Context mContext;

    public ClassGambitDelegate(Context Context)
    {
    ...
    @Override
    public void initCustomView(BaseViewHolder holder, final List<GambitEntity> data, final int position) {
        Log.d("zw--size",data.size()+"sss");
        ...
        final GambitEntity gambitEntity = data.get(position);
        ...
        List<String> imgs = gambitEntity.getImgs();
        if(imgs.size()==0){
