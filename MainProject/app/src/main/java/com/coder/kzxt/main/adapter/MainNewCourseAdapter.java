 ...
 * 最新推荐课程
 */
public class MainNewCourseAdapter {
   ...
   // private PublicUtils pu;
    ...
    private static final String
            NEW_ZHENG_FOUR_1 = "NEW_ZHENG_FOUR_1", NEW_ZHENG_FOUR_2 = "NEW_ZHENG_FOUR_2",
            NEW_SHU_TWO_1 = "NEW_SHU_TWO_1", NEW_SHU_TWO_2 = "NEW_SHU_TWO_2",
            NEW_SHANGTUO_TWO_1 = "NEW_SHANGTUO_TWO_1", NEW_SHANGTUO_TWO_2 = "NEW_SHANGTUO_TWO_2",
            NEW_HENGXIANG_TWO_1 = "NEW_HENGXIANG_TWO_1", NEW_HENGXIANG_TWO_2 = "NEW_HENGXIANG_TWO_2",
            NEW_SHUONE_HENGTWO_1 = "NEW_SHUONE_HENGTWO_1", NEW_SHUONE_HENGTWO_2 = "NEW_SHUONE_HENGTWO_2",
            NEW_SHUONE_HENGTWO_XIAHENGONE_1 = "NEW_SHUONE_HENGTWO_XIAHENGONE_1", NEW_SHUONE_HENGTWO_XIAHENGONE_2 = "NEW_SHUONE_HENGTWO_XIAHENGONE_2",
            NEW_SHUONE_HENGTWO_XIASHUTWO_1 = "NEW_SHUONE_HENGTWO_XIASHUTWO_1", NEW_SHUONE_HENGTWO_XIASHUTWO_2 = "NEW_SHUONE_HENGTWO_XIASHUTWO_2",
            NEW_ZHENGFOUR_XIAHENGONE_1 = "NEW_ZHENGFOUR_XIAHENGONE_1", NEW_ZHENGFOUR_XIAHENGONE_2 = "NEW_ZHENGFOUR_XIAHENGONE_2";

    /**
     * 需要显示老师名称和学习人数的
     */
    public static String showTeacherAndNumber = NEW_ZHENG_FOUR_1 + "," + NEW_SHU_TWO_1 + "," + NEW_SHANGTUO_TWO_1 + "," +
            NEW_HENGXIANG_TWO_1 + "," + NEW_SHUONE_HENGTWO_1 + "," + NEW_SHUONE_HENGTWO_XIAHENGONE_1 + "," +
            NEW_SHUONE_HENGTWO_XIASHUTWO_1 + "," + NEW_ZHENGFOUR_XIAHENGONE_1;


    public static String types = NEW_ZHENG_FOUR_1 + "," + NEW_ZHENG_FOUR_2 + "," + NEW_SHU_TWO_1 + "," + NEW_SHU_TWO_2 + "," + NEW_SHANGTUO_TWO_1 + "," + NEW_SHANGTUO_TWO_2 + "," +
            NEW_HENGXIANG_TWO_1 + "," + NEW_HENGXIANG_TWO_2 + "," + NEW_SHUONE_HENGTWO_1 + "," + NEW_SHUONE_HENGTWO_2 + "," +
            "" + NEW_SHUONE_HENGTWO_XIAHENGONE_1 + "," + NEW_SHUONE_HENGTWO_XIAHENGONE_2 + "," +
            NEW_SHUONE_HENGTWO_XIASHUTWO_1 + "," + NEW_SHUONE_HENGTWO_XIASHUTWO_2 + "," + NEW_ZHENGFOUR_XIAHENGONE_1 + "," + NEW_ZHENGFOUR_XIAHENGONE_2;


    public MainNewCourseAdapter(Activity mContext, MainModelBean.ItemsBean moduleType, List<MainModelBean.ItemsBean.ListBean> data) {
        super();
    ...
    public View getView() {
        ...
        switch (configBean.getModule_style()) {
            case NEW_ZHENG_FOUR_1:
                view = disPlayGridView(view);
                break;
            case NEW_ZHENG_FOUR_2:
                view = disPlayGridView(view);
                break;
            case NEW_SHU_TWO_1:
            ...
            case NEW_SHU_TWO_2:
                view = disPlayListView(view, 2);
                break;
            case NEW_SHANGTUO_TWO_1:
                view = setListViewGridView(view, 2);
                break;
            case NEW_SHANGTUO_TWO_2:
                view = setListViewGridView(view, 2);
                break;
            case NEW_HENGXIANG_TWO_1:
                view = disPlayListView(view, 1);
                break;
            case NEW_HENGXIANG_TWO_2:
                view = disPlayListView(view, 1);
                break;
            //不规则
            case NEW_SHUONE_HENGTWO_1:
                view = setListViewThreeItem(view);
                break;
            case NEW_SHUONE_HENGTWO_2:
                view = setListViewThreeItem(view);
                break;
            case NEW_SHUONE_HENGTWO_XIAHENGONE_1:
                view = setListViewListView(view);
                break;
            case NEW_SHUONE_HENGTWO_XIAHENGONE_2:
                view = setListViewListView(view);
                break;
            case NEW_SHUONE_HENGTWO_XIASHUTWO_1:
                view = setGridViewThreeItem(view);
                break;
            case NEW_SHUONE_HENGTWO_XIASHUTWO_2:
                view = setGridViewThreeItem(view);
                break;
            case NEW_ZHENGFOUR_XIAHENGONE_1:
                view = setListViewGridView(view, 4);
                break;
            case NEW_ZHENGFOUR_XIAHENGONE_2:
                view = setListViewGridView(view, 4);
                break;
            default:
                view = disPlayListView(view, 1);
        ...
        loadMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // mContext.startActivity(new Intent(mContext, LocalCourseListActivity.class).putExtra("title",configBean.getModuleName()).putExtra("type",LocalCourseListActivity.LATEST_COURSELIST));
            }
        });
        return view;
    }
