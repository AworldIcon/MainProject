...
package com.coder.kzxt.wheel.widget;
...
import com.coder.kzxt.wheel.widget.adapters.WheelViewAdapter;
...
//		bottomShadow.draw(canvas);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.first_theme));
		// 设置线宽
