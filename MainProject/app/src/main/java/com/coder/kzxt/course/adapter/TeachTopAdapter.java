...
public class TeachTopAdapter extends RecyclerView.Adapter<TeachTopAdapter.MyViewHolder> {


    private Context mContext;
    private ArrayList<TeachBean.TeachCourseItem> courseItems;

    public TeachTopAdapter(Context context, ArrayList<TeachBean.TeachCourseItem> datas){
