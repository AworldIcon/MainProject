 ...
 * 聊天时 功能区的考试列表
 */
public class TestFragment extends BaseFragment implements HttpCallBack
{
    ...
    private void initClick()
    {
        ...
        stageadapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener()
        {
            ...
            {
                TeaWorkRecourseActivity.gotoActivity(getActivity(),course_id,class_id,"1");
            }
        });
    ...
    public void setOnErrorCallback(int requestCode, int code, String msg)
    {
        ...
        {
            //重新登录
            NetworkUtil.httpRestartLogin(TestFragment.this, relativeLayout);
        } else
        {
            //加载失败
