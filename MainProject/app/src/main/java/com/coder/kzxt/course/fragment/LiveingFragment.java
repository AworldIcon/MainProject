 ...
 * 正在直播 的页面
 */
public class LiveingFragment extends BaseFragment implements HttpCallBack
{
    ...
    public static Fragment newInstance(String treeId) {
        LiveingFragment f = new LiveingFragment();
        Bundle b = new Bundle();
    ...
    {
        //stage的初始化
        pullDelegate = new LiveDelegate(getActivity(),1,"");
    ...
    public void setOnSuccessCallback(int requestCode, Object resultBean) {
        ...
        if (TextUtils.isEmpty(treeId)) {
            ...
            for (int i = 0; i < itemsBeanListL.size(); i++) {
                if(itemsBeanListL.get(i).getLive_status()==1){
    ...
    public void setOnErrorCallback(int requestCode, int code, String msg) {
        ...
        if (code == Constants.HTTP_CODE_2001 || code == Constants.HTTP_CODE_2004 || code == Constants.HTTP_CODE_8000) {
            NetworkUtil.httpRestartLogin(LiveingFragment.this, mainView);
        } else {
