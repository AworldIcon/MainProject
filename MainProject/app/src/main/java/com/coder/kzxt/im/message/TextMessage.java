...
//            if (message.getElement(0) == null) return;
//            stringBuffer.append(((TIMTextElem) message.getElement(0)).getText());
//        } else {
...
//            textElem = new TIMTextElem();
//            textElem.setText(stringBuffer.toString());
//        }

        SpannableString spannableString = EmojiUtil.getInstace().getSpannableString(context, stringBuffer.toString());
