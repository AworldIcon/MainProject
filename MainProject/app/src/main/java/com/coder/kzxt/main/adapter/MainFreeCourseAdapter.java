 ...
 * 免费好课
 */
public class MainFreeCourseAdapter {
   ...
   // private PublicUtils pu;
    ...
    private static final String
            FREE_ZHENG_FOUR_1 = "FREE_ZHENG_FOUR", FREE_ZHENG_FOUR_2 = "FREE_ZHENG_FOUR_2",
            FREE_SHU_TWO_1 = "FREE_SHU_TWO", FREE_SHU_TWO_2 = "FREE_SHU_TWO_2",
            FREE_SHANGTUO_TWO_1 = "FREE_SHANGTUO_TWO", FREE_SHANGTUO_TWO_2 = "FREE_SHANGTUO_TWO_2",
            FREE_HENGXIANG_TWO_1 = "FREE_HENGXIANG_TWO", FREE_HENGXIANG_TWO_2 = "FREE_HENGXIANG_TWO_2",
            FREE_SHUONE_HENGTWO_1 = "FREE_SHUONE_HENGTWO", FREE_SHUONE_HENGTWO_2 = "FREE_SHUONE_HENGTWO_2",
            FREE_SHUONE_HENGTWO_XIAHENGONE_1 = "FREE_SHUONE_HENGTWO_XIAHENGONE", FREE_SHUONE_HENGTWO_XIAHENGONE_2 = "FREE_SHUONE_HENGTWO_XIAHENGONE_2",
            FREE_SHUONE_HENGTWO_XIASHUTWO_1 = "FREE_SHUONE_HENGTWO_XIASHUTWO", FREE_SHUONE_HENGTWO_XIASHUTWO_2 = "FREE_SHUONE_HENGTWO_XIASHUTWO_2",
            FREE_ZHENGFOUR_XIAHENGONE_1 = "FREE_ZHENGFOUR_XIAHENGONE", FREE_ZHENGFOUR_XIAHENGONE_2 = "FREE_ZHENGFOUR_XIAHENGONE_2";
    /**
     * 需要显示老师名称和学习人数的
     */
    public static String showTeacherAndNumber = FREE_ZHENG_FOUR_1 + "," + FREE_SHU_TWO_1 + "," + FREE_SHANGTUO_TWO_1 + "," +
            FREE_HENGXIANG_TWO_1 + "," + FREE_SHUONE_HENGTWO_1 + "," + FREE_SHUONE_HENGTWO_XIAHENGONE_1 + "," +
            FREE_SHUONE_HENGTWO_XIASHUTWO_1 + "," + FREE_ZHENGFOUR_XIAHENGONE_1;


    public static String types = FREE_ZHENG_FOUR_1 + "," + FREE_ZHENG_FOUR_2 + "," + FREE_SHU_TWO_1 + "," + FREE_SHU_TWO_2 + "," + FREE_SHANGTUO_TWO_1 + "," + FREE_SHANGTUO_TWO_2 + "," +
            FREE_HENGXIANG_TWO_1 + "," + FREE_HENGXIANG_TWO_2 + "," + FREE_SHUONE_HENGTWO_1 + "," + FREE_SHUONE_HENGTWO_2 + "," +
            "" + FREE_SHUONE_HENGTWO_XIAHENGONE_1 + "," + FREE_SHUONE_HENGTWO_XIAHENGONE_2 + "," +
            FREE_SHUONE_HENGTWO_XIASHUTWO_1 + "," + FREE_SHUONE_HENGTWO_XIASHUTWO_2 + "," + FREE_ZHENGFOUR_XIAHENGONE_1 + "," + FREE_ZHENGFOUR_XIAHENGONE_2;

    public MainFreeCourseAdapter(Activity mContext, MainModelBean.ItemsBean moduleType, List<MainModelBean.ItemsBean.ListBean> data) {
        super();
    ...
    public View getView() {
        ...
        switch (configBean.getModule_style()) {
            case FREE_ZHENG_FOUR_1:
                view = disPlayGridView(view);
                break;
            case FREE_ZHENG_FOUR_2:
                view = disPlayGridView(view);
                break;
            case FREE_SHU_TWO_1:
            ...
            case FREE_SHU_TWO_2:
                view = disPlayListView(view, 2);
                break;
            case FREE_SHANGTUO_TWO_1:
                view = setListViewGridView(view, 2);
                break;
            case FREE_SHANGTUO_TWO_2:
                view = setListViewGridView(view, 2);
                break;
            case FREE_HENGXIANG_TWO_1:
                view = disPlayListView(view, 1);
                break;
            case FREE_HENGXIANG_TWO_2:
                view = disPlayListView(view, 1);
                break;
            //不规则
            case FREE_SHUONE_HENGTWO_1:
                view = setListViewThreeItem(view);
                break;
            case FREE_SHUONE_HENGTWO_2:
                view = setListViewThreeItem(view);
                break;
            case FREE_SHUONE_HENGTWO_XIAHENGONE_1:
                view = setListViewListView(view);
                break;
            case FREE_SHUONE_HENGTWO_XIAHENGONE_2:
                view = setListViewListView(view);
                break;
            case FREE_SHUONE_HENGTWO_XIASHUTWO_1:
                view = setGridViewThreeItem(view);
                break;
            case FREE_SHUONE_HENGTWO_XIASHUTWO_2:
                view = setGridViewThreeItem(view);
                break;
            case FREE_ZHENGFOUR_XIAHENGONE_1:
                view = setListViewGridView(view, 4);
                break;
            case FREE_ZHENGFOUR_XIAHENGONE_2:
                view = setListViewGridView(view, 4);
                break;
            default:
                view = disPlayListView(view, 1);
        ...
        loadMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // mContext.startActivity(new Intent(mContext, LocalCourseListActivity.class).putExtra("title",configBean.getModuleName()).putExtra("type",LocalCourseListActivity.FREE_COURSE_LIST));
            }
        });
        return view;
    }
