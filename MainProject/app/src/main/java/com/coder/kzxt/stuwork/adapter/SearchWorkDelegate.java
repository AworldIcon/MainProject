...
/**
 * Created by zw on 2017/4/11.
 */

public class SearchWorkDelegate extends BaseDelegate<String>
{
    ...
    public SearchWorkDelegate(Context context, SearchHistoryUtils searchHistoryUtils,TextView clear_history)
    {
