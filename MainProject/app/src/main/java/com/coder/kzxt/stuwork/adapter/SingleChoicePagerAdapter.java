 ...
 * 
 */
public class SingleChoicePagerAdapter extends PagerAdapter {
	...
	public SingleChoicePagerAdapter(final Activity context, final ArrayList<QuestionContent> arrayList,
									String score, ArrayList<CommitAnswer> answers, String showType,
									String resultId, String showFinish, String commitType,
									String workType,Boolean isCourse) {
	...
	public Object instantiateItem(final View arg0, final int arg1) {
		...
		question_type_tx.setText(context.getResources().getString(R.string.single_choice_type));
		...
		selectList.setAdapter(new ChoiceListAdapter(context, arrayList.get(arg1).getChoicesList(), "single_choice", arg1, answers.get(arg1)));
		...
		if (showType.equals(TestPageActivity.TEST_PAGE_STATUS_TEST)) {
			...
			if (arrayList.get(arg1).getMyAnswers().size() > 0) {
				yourAnswer.setText(context.getResources().getString(R.string.your_result) + TextUitl.singleChoiceAnswersText(arrayList.get(arg1).getMyAnswers().get(0)));
			}
			if (arrayList.get(arg1).getAnswers() != null) {
				correctAnswer.setText(context.getResources().getString(R.string.correct_result) + TextUitl.singleChoiceAnswersText(arrayList.get(arg1).getAnswers().get(0)));
			}
