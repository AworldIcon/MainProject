 ...
 * 签到详情列表 已签到
 */
public class SignDetailSignedFragment extends BaseFragment implements HttpCallBack
{
    ...
    public void setOnErrorCallback(int requestCode, int code, String msg)
    {
        ...
        {
            //重新登录
            NetworkUtil.httpRestartLogin(SignDetailSignedFragment.this, relativeLayout);
        } else
        {
            //加载失败
