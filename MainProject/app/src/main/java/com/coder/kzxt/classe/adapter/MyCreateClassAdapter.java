...
public class MyCreateClassAdapter extends RecyclerView.Adapter<MyCreateClassAdapter.MyViewHolder> {


    private Context mContext;
    private ArrayList<MyCreateClass.CreateClassBean> classItems;

    public MyCreateClassAdapter(Context context, ArrayList<MyCreateClass.CreateClassBean> datas) {
