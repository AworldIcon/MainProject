 ...
 * 本校课程
 */
public class MainCoustomAdapter {
    ...
    private static final String
            SCHOOL_ZHENG_FOUR_1 = "CUSTOM_ZHENG_FOUR_1", SCHOOL_ZHENG_FOUR_2 = "CUSTOM_ZHENG_FOUR_2",
            SCHOOL_SHU_TWO_1 = "CUSTOM_SHU_TWO_1", SCHOOL_SHU_TWO_2 = "CUSTOM_SHU_TWO_2",
            SCHOOL_SHANGTUO_TWO_1 = "CUSTOM_SHANGTUO_TWO_1", SCHOOL_SHANGTUO_TWO_2 = "CUSTOM_SHANGTUO_TWO_2",
            SCHOOL_HENGXIANG_TWO_1 = "CUSTOM_HENGXIANG_TWO_1", SCHOOL_HENGXIANG_TWO_2 = "CUSTOM_HENGXIANG_TWO_2",
            SCHOOL_SHUONE_HENGTWO_1 = "CUSTOM_SHUONE_HENGTWO_1", SCHOOL_SHUONE_HENGTWO_2 = "CUSTOM_SHUONE_HENGTWO_2",
            SCHOOL_SHUONE_HENGTWO_XIAHENGONE_1 = "CUSTOM_SHUONE_HENGTWO_XIAHENGONE_1", SCHOOL_SHUONE_HENGTWO_XIAHENGONE_2 = "CUSTOM_SHUONE_HENGTWO_XIAHENGONE_2",
            SCHOOL_SHUONE_HENGTWO_XIASHUTWO_1 = "CUSTOM_SHUONE_HENGTWO_XIASHUTWO_1", SCHOOL_SHUONE_HENGTWO_XIASHUTWO_2 = "CUSTOM_SHUONE_HENGTWO_XIASHUTWO_2",
            SCHOOL_ZHENGFOUR_XIAHENGONE_1 = "CUSTOM_ZHENGFOUR_XIAHENGONE_1", SCHOOL_ZHENGFOUR_XIAHENGONE_2 = "CUSTOM_ZHENGFOUR_XIAHENGONE_2";
    /**
     * 需要显示老师名称和学习人数的
     */
    public static String showTeacherAndNumber = SCHOOL_ZHENG_FOUR_1 + "," + SCHOOL_SHU_TWO_1 + "," + SCHOOL_SHANGTUO_TWO_1 + "," +
            SCHOOL_HENGXIANG_TWO_1 + "," + SCHOOL_SHUONE_HENGTWO_1 + "," + SCHOOL_SHUONE_HENGTWO_XIAHENGONE_1 + "," +
            SCHOOL_SHUONE_HENGTWO_XIASHUTWO_1 + "," + SCHOOL_ZHENGFOUR_XIAHENGONE_1;


    public static String types = SCHOOL_ZHENG_FOUR_1 + "," + SCHOOL_ZHENG_FOUR_2 + "," + SCHOOL_SHU_TWO_1 + "," + SCHOOL_SHU_TWO_2 + "," + SCHOOL_SHANGTUO_TWO_1 + "," + SCHOOL_SHANGTUO_TWO_2 + "," +
            SCHOOL_HENGXIANG_TWO_1 + "," + SCHOOL_HENGXIANG_TWO_2 + "," + SCHOOL_SHUONE_HENGTWO_1 + "," + SCHOOL_SHUONE_HENGTWO_2 + "," +
            "" + SCHOOL_SHUONE_HENGTWO_XIAHENGONE_1 + "," + SCHOOL_SHUONE_HENGTWO_XIAHENGONE_2 + "," +
            SCHOOL_SHUONE_HENGTWO_XIASHUTWO_1 + "," + SCHOOL_SHUONE_HENGTWO_XIASHUTWO_2 + "," + SCHOOL_ZHENGFOUR_XIAHENGONE_1 + "," + SCHOOL_ZHENGFOUR_XIAHENGONE_2;


    public MainCoustomAdapter(Activity mContext, MainModelBean.ItemsBean moduleType, List<MainModelBean.ItemsBean.ListBean> data) {
        super();
    ...
    public View getView() {
        ...
        switch (configBean.getModule_style()) {
            case SCHOOL_ZHENG_FOUR_1:
                view = disPlayGridView(view);
                break;
            case SCHOOL_ZHENG_FOUR_2:
                view = disPlayGridView(view);
                break;
            case SCHOOL_SHU_TWO_1:
                view = disPlayListView(view, 2);
                break;
            case SCHOOL_SHU_TWO_2:
                view = disPlayListView(view, 2);
                break;
            case SCHOOL_SHANGTUO_TWO_1:
                view = setListViewGridView(view, 2);
                break;
            case SCHOOL_SHANGTUO_TWO_2:
                view = setListViewGridView(view, 2);
                break;
            case SCHOOL_HENGXIANG_TWO_1:
                view = disPlayListView(view, 1);
                break;
            case SCHOOL_HENGXIANG_TWO_2:
                view = disPlayListView(view, 1);
                break;
            //不规则
            case SCHOOL_SHUONE_HENGTWO_1:
                view = setListViewThreeItem(view);
                break;
            case SCHOOL_SHUONE_HENGTWO_2:
                view = setListViewThreeItem(view);
                break;
            case SCHOOL_SHUONE_HENGTWO_XIAHENGONE_1:
                view = setListViewListView(view);
                break;
            case SCHOOL_SHUONE_HENGTWO_XIAHENGONE_2:
                view = setListViewListView(view);
                break;
            case SCHOOL_SHUONE_HENGTWO_XIASHUTWO_1:
                view = setGridViewThreeItem(view);
                break;
            case SCHOOL_SHUONE_HENGTWO_XIASHUTWO_2:
                view = setGridViewThreeItem(view);
                break;
            case SCHOOL_ZHENGFOUR_XIAHENGONE_1:
                view = setListViewGridView(view, 4);
                break;
            case SCHOOL_ZHENGFOUR_XIAHENGONE_2:
                view = setListViewGridView(view, 4);
                break;
            default:
                view = disPlayListView(view, 1);
        ...
        loadMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //   mContext.startActivity(new Intent(mContext, LocalCourseListActivity.class).putExtra("title",configBean.getModuleName()).putExtra("type",LocalCourseListActivity.LOCAL_COURSE));
            }
        });
        return view;
    }
