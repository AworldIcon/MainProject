...
import com.coder.kzxt.stuwork.adapter.FillPagerAdapter;
...
public class FillFragment extends BaseFragment {
	...
	private FillPagerAdapter adapter;
	...
	public FillPagerAdapter getAdapter(){
		return adapter;
	}
	@Override
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (v == null) {
			...
			adapter = new FillPagerAdapter(getActivity(), contents, score, answers, showType, resultId, showFinish, commitType, isCenter,isCourse);
