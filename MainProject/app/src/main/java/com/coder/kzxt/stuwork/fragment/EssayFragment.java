...
import com.coder.kzxt.stuwork.adapter.EssayPagerAdapter;
...
public class EssayFragment extends BaseFragment {
	...
	public EssayPagerAdapter getAdapter(){
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (v == null) {
			...
			viewPageAdapter = new EssayPagerAdapter(getActivity(), contents, score, answers, showType, resultId, showFinish, commitType, isCenter,isCourse);
