 ...
 * 本校课程
 */
public class MainSchoolCourseAdapter {
    ...
    private static final String
            SCHOOL_ZHENG_FOUR_1 = "SCHOOL_ZHENG_FOUR_1", SCHOOL_ZHENG_FOUR_2 = "SCHOOL_ZHENG_FOUR_2",
            SCHOOL_SHU_TWO_1 = "SCHOOL_SHU_TWO_1", SCHOOL_SHU_TWO_2 = "SCHOOL_SHU_TWO_2",
            SCHOOL_SHANGTUO_TWO_1 = "SCHOOL_SHANGTUO_TWO_1", SCHOOL_SHANGTUO_TWO_2 = "SCHOOL_SHANGTUO_TWO_2",
            SCHOOL_HENGXIANG_TWO_1 = "SCHOOL_HENGXIANG_TWO_1", SCHOOL_HENGXIANG_TWO_2 = "SCHOOL_HENGXIANG_TWO_2",
            SCHOOL_SHUONE_HENGTWO_1 = "SCHOOL_SHUONE_HENGTWO_1", SCHOOL_SHUONE_HENGTWO_2 = "SCHOOL_SHUONE_HENGTWO_2",
            SCHOOL_SHUONE_HENGTWO_XIAHENGONE_1 = "SCHOOL_SHUONE_HENGTWO_XIAHENGONE_1", SCHOOL_SHUONE_HENGTWO_XIAHENGONE_2 = "SCHOOL_SHUONE_HENGTWO_XIAHENGONE_2",
            SCHOOL_SHUONE_HENGTWO_XIASHUTWO_1 = "SCHOOL_SHUONE_HENGTWO_XIASHUTWO_1", SCHOOL_SHUONE_HENGTWO_XIASHUTWO_2 = "SCHOOL_SHUONE_HENGTWO_XIASHUTWO_2",
            SCHOOL_ZHENGFOUR_XIAHENGONE_1 = "SCHOOL_ZHENGFOUR_XIAHENGONE_1", SCHOOL_ZHENGFOUR_XIAHENGONE_2 = "SCHOOL_ZHENGFOUR_XIAHENGONE_2";
    /**
     * 需要显示老师名称和学习人数的
     */
    ...
    public MainSchoolCourseAdapter(Activity mContext, MainModelBean.ItemsBean moduleType, List<MainModelBean.ItemsBean.ListBean> data) {
        super();
