...
public class EmojiAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_chat_face, null);
			viewHolder.iv_face = (ImageView) convertView.findViewById(R.id.item_im_face);
		...
		if (emoji.equals(EmojiUtil.EMOJI_DELETE_NAME)) {
			viewHolder.iv_face.setImageResource(R.drawable.emoji_delete);
