...
//                    name = message.getSenderGroupMemberProfile().getNameCard();
    ...
    public String getAvatar()
    {
        ...
        {
            if (FriendshipInfo.getInstance().getProfile(message.getSender()) == null) return "";
            return FriendshipInfo.getInstance().getProfile(message.getSender()).getAvatarUrl();
        } else if (message.getConversation().getType() == TIMConversationType.Group)
        {
