...
public class DoneOrderDelegate extends PullRefreshDelegate<MyOrderBean.OrderBean> {

    private Context mContext;

    public DoneOrderDelegate(Context context) {
        ...
        if (orderListener != null) {
            cancleOrder.setOnClickListener(new View.OnClickListener() { //取消订单
                ...
                public void onClick(View view) {
                    orderListener.onOrderCancle(orderBean, DoneOrderDelegate.this);
                }
            });
