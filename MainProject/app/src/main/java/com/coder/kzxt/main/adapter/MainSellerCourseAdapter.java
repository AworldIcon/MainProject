 ...
 * 畅销好课
 */
public class MainSellerCourseAdapter {
    ...
    private static final String
            SELLER_ZHENG_FOUR_1 = "SELLER_ZHENG_FOUR", SELLER_ZHENG_FOUR_2 = "SELLER_ZHENG_FOUR_2",
            SELLER_SHU_TWO_1 = "SELLER_SHU_TWO", SELLER_SHU_TWO_2 = "SELLER_SHU_TWO_2",
            SELLER_SHANGTUO_TWO_1 = "SELLER_SHANGTUO_TWO", SELLER_SHANGTUO_TWO_2 = "SELLER_SHANGTUO_TWO_2",
            SELLER_HENGXIANG_TWO_1 = "SELLER_HENGXIANG_TWO", SELLER_HENGXIANG_TWO_2 = "SELLER_HENGXIANG_TWO_2",
            SELLER_SHUONE_HENGTWO="SELLER_SHUONE_HENGTWO",
            SELLER_SHUONE_HENGTWO_1 = "SELLER_SHUONE_HENGTWO_1", SELLER_SHUONE_HENGTWO_2 = "SELLER_SHUONE_HENGTWO_2",
            SELLER_SHUONE_HENGTWO_XIAHENGONE_1 = "SELLER_SHUONE_HENGTWO_XIAHENGONE", SELLER_SHUONE_HENGTWO_XIAHENGONE_2 = "SELLER_SHUONE_HENGTWO_XIAHENGONE_2",
            SELLER_SHUONE_HENGTWO_XIASHUTWO_1 = "SELLER_SHUONE_HENGTWO_XIASHUTWO", SELLER_SHUONE_HENGTWO_XIASHUTWO_2 = "SELLER_SHUONE_HENGTWO_XIASHUTWO_2",
            SELLER_ZHENGFOUR_XIAHENGONE_1 = "SELLER_ZHENGFOUR_XIAHENGONE", SELLER_ZHENGFOUR_XIAHENGONE_2 = "SELLER_ZHENGFOUR_XIAHENGONE_2";
    /**
     * 需要显示老师名称和学习人数的
     */
    public static String showTeacherAndNumber = SELLER_ZHENG_FOUR_1 + "," + SELLER_SHU_TWO_1 + "," + SELLER_SHANGTUO_TWO_1 + "," +
            SELLER_HENGXIANG_TWO_1 + "," + SELLER_SHUONE_HENGTWO_1 + "," + SELLER_SHUONE_HENGTWO_XIAHENGONE_1 + "," +
            SELLER_SHUONE_HENGTWO_XIASHUTWO_1 + "," + SELLER_ZHENGFOUR_XIAHENGONE_1;


    public static String types = SELLER_ZHENG_FOUR_1 + "," + SELLER_ZHENG_FOUR_2 + "," + SELLER_SHU_TWO_1 + "," + SELLER_SHU_TWO_2 + "," + SELLER_SHANGTUO_TWO_1 + "," + SELLER_SHANGTUO_TWO_2 + "," +
            SELLER_HENGXIANG_TWO_1 + "," + SELLER_HENGXIANG_TWO_2 + "," + SELLER_SHUONE_HENGTWO_1 + "," + SELLER_SHUONE_HENGTWO_2 + "," +
            "" + SELLER_SHUONE_HENGTWO_XIAHENGONE_1 + "," + SELLER_SHUONE_HENGTWO_XIAHENGONE_2 + "," +
            SELLER_SHUONE_HENGTWO_XIASHUTWO_1 + "," + SELLER_SHUONE_HENGTWO_XIASHUTWO_2 + "," + SELLER_ZHENGFOUR_XIAHENGONE_1 + "," + SELLER_ZHENGFOUR_XIAHENGONE_2;


    public MainSellerCourseAdapter(Activity mContext, MainModelBean.ItemsBean moduleType, List<MainModelBean.ItemsBean.ListBean> data) {
        super();
    ...
    public View getView() {
        ...
        switch (configBean.getModule_style()) {
            case SELLER_ZHENG_FOUR_1:
                view = disPlayGridView(view);
                break;
            case SELLER_ZHENG_FOUR_2:
                view = disPlayGridView(view);
                break;
            case SELLER_SHU_TWO_1:
                view = disPlayListView(view, 2);
                break;
            case SELLER_SHU_TWO_2:
                view = disPlayListView(view, 2);
                break;
            case SELLER_SHANGTUO_TWO_1:
                view = setListViewGridView(view, 2);
                break;
            case SELLER_SHANGTUO_TWO_2:
                view = setListViewGridView(view, 2);
                break;
            case SELLER_HENGXIANG_TWO_1:
                view = disPlayListView(view, 1);
                break;
            case SELLER_HENGXIANG_TWO_2:
                view = disPlayListView(view, 1);
                break;
            //不规则
            case SELLER_SHUONE_HENGTWO_1:
                view = setListViewThreeItem(view);
                break;
            case SELLER_SHUONE_HENGTWO:
                view = setListViewThreeItem(view);
                break;
            case SELLER_SHUONE_HENGTWO_2:
                view = setListViewThreeItem(view);
                break;
            case SELLER_SHUONE_HENGTWO_XIAHENGONE_1:
                view = setListViewListView(view);
                break;
            case SELLER_SHUONE_HENGTWO_XIAHENGONE_2:
                view = setListViewListView(view);
                break;
            case SELLER_SHUONE_HENGTWO_XIASHUTWO_1:
                view = setGridViewThreeItem(view);
                break;
            case SELLER_SHUONE_HENGTWO_XIASHUTWO_2:
                view = setGridViewThreeItem(view);
                break;
            case SELLER_ZHENGFOUR_XIAHENGONE_1:
                view = setListViewGridView(view, 4);
                break;
            case SELLER_ZHENGFOUR_XIAHENGONE_2:
                view = setListViewGridView(view, 4);
                break;
            default:
                view = disPlayListView(view, 1);
        ...
        loadMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // mContext.startActivity(new Intent(mContext, LocalCourseListActivity.class).putExtra("title", configBean.getModuleName()).putExtra("type", LocalCourseListActivity.POPULAR_COURSE_LIST));
            }
        });
        return view;
    }
