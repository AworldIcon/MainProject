...
public class TeacherApplyAdapter extends RecyclerView.Adapter<TeacherApplyAdapter.MyViewHolder>{
    private Context mContext;
    private ArrayList<ClassApplyResult.ClassApplyBean> classApplys;

    public TeacherApplyAdapter(Context context,ArrayList<ClassApplyResult.ClassApplyBean> applyBeens) {
        this.mContext = context;
        this.classApplys = applyBeens;
    }

    @Override
    public TeacherApplyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.apply_list_item,parent,false);
        return new TeacherApplyAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(TeacherApplyAdapter.MyViewHolder holder, final int position) {
