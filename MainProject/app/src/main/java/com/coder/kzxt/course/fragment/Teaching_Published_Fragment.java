...
public class Teaching_Published_Fragment extends BaseFragment implements HttpCallBack {
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (v == null) {
            v = inflater.inflate(R.layout.fragment_teaching_published, container, false);
    ...
    public void setOnErrorCallback(int requestCode, int code, String msg) {
        ...
        if(code== Constants.HTTP_CODE_2001||code==Constants.HTTP_CODE_2004){
            NetworkUtil.httpRestartLogin(Teaching_Published_Fragment.this,my_ly);
        }
    }
}
