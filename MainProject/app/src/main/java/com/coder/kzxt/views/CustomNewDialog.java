...
public class CustomNewDialog extends Dialog {
	...
	public CustomNewDialog(final Context context) {
		this(context, R.layout.dlg_custom_new_view, Gravity.CENTER);
	...
	public CustomNewDialog(final Context context, final int layout) {
		this(context, layout, Gravity.CENTER);
	}

	public CustomNewDialog(final Context context, final int layout, final int theme) {
		this(context, layout,  R.style.DialogBlack, theme);
	}

	public CustomNewDialog(final Context context, final int layout, final int theme, int gravity) {
		super(context, theme);
	...
	public void setButtonOne(Boolean isShowOneButton) {
		if (isShowOneButton) {
	...
	public void setLeftTextColor(int color) {
		if (this.leftTextView != null && color != 0) {
			leftTextView.setTextColor(context.getResources().getColor(color));
		}
	}
