...
public class FillPagerAdapter extends PagerAdapter {

	private ArrayList<View> pagerViews;
	private ArrayList<QuestionContent> arrayList;
	...
	public FillPagerAdapter(final Activity context, final ArrayList<QuestionContent> arrayList,
	...
	public Object instantiateItem(final View arg0, final int arg1) {
		...
		question_type_tx.setText(context.getResources().getString(R.string.gap_filling));
		...
		selectList.setAdapter(new FillListAdapter(context, arrayList.get(arg1).getAnswers(),arg1,answers.get(arg1),answers.get(arg1).getResultList()));
...
//
         ...
         if(showType.equals(TestPageActivity.TEST_PAGE_STATUS_TEST)){
			 ...
			 if(arrayList.get(arg1).getMyAnswers().size()>0){
				 yourAnswer.setText(context.getResources().getString(R.string.your_result)+ TextUitl.fillAnswersText(arrayList.get(arg1).getMyAnswers()));

			 }
			 if(arrayList.get(arg1).getAnswers()!=null){
				 correctAnswer.setText(context.getResources().getString(R.string.correct_result)+TextUitl.fillAnswersText(arrayList.get(arg1).getAnswers()));
			 }
