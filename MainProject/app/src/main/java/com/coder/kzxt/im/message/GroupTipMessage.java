...
public class GroupTipMessage extends Message {
    ...
    public String getSummary() {
        ...
        switch (e.getTipsType()){
            case CancelAdmin:
            case SetAdmin:
                return MyApplication.getInstance().getApplicationContext().getString(R.string.summary_group_admin_change);
            case Join:
                ...
                return stringBuilder +
                        MyApplication.getInstance().getApplicationContext().getString(R.string.summary_group_mem_add);
            case Kick:
                return e.getUserList().get(0) +
                        MyApplication.getInstance().getApplicationContext().getString(R.string.summary_group_mem_kick);
            case ModifyMemberInfo:
                ...
                return stringBuilder +
                        MyApplication.getInstance().getApplicationContext().getString(R.string.summary_group_mem_modify);
            case Quit:
                return e.getOpUser() +
                        MyApplication.getInstance().getApplicationContext().getString(R.string.summary_group_mem_quit);
            case ModifyGroupInfo:
                return MyApplication.getInstance().getApplicationContext().getString(R.string.summary_group_info_change);
        }
        return "";
    }
