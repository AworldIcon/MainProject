...
public class FileMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        tv.setTextColor(MyApplication.getInstance().getApplicationContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        return MyApplication.getInstance().getApplicationContext().getString(R.string.summary_file);
    }
    ...
    public void save() {
        ...
        e.getFile(new TIMValueCallBack<byte[]>() {
            ...
            public void onError(int i, String s) {
                L.e(TAG, "getFile failed. code: " + i + " errmsg: " + s);
            }
