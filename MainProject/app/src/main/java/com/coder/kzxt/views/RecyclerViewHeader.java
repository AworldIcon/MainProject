...
import com.coder.kzxt.recyclerview.layoutmanager.WrapContentLinearLayoutManager;
    ...
    private static class LayoutManagerDelegate {
        ...
        private LayoutManagerDelegate(@NonNull RecyclerView.LayoutManager manager) {
            ...
            if (managerClass == LinearLayoutManager.class ||
                    managerClass == WrapContentLinearLayoutManager.class) { //not using instanceof on purpose
                ...
                staggeredGrid = null;
//            } else if (manager instanceof StaggeredGridLayoutManager) { //TODO: implement staggered
//                linear = null;
//                grid = null;
...
//                return staggeredGrid.getSpanCount(); //TODO:implement staggered
            }
...
//            } else if (staggeredGrid != null) {
//                return staggeredGrid.findFirstCompletelyVisibleItemPositions() //TODO: implement staggered
            }
...
//            } else if (staggeredGrid != null) {
//                return ; //TODO: implement staggered
            }
            return false; //shouldn't get here
        }
