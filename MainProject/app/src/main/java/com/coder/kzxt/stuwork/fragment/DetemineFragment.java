...
import com.coder.kzxt.stuwork.adapter.DeteminPagerAdapter;
 ...
 * @author pc
 */
public class DetemineFragment extends BaseFragment {
	...
	private DeteminPagerAdapter viewPageAdapter;
	...
	public DeteminPagerAdapter getAdapter(){
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (v == null) {
			...
			viewPageAdapter = new DeteminPagerAdapter(getActivity(), contents, score, answers, showType, resultId, showFinish, commitType, isCenter,isCourse);
