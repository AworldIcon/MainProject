...
public class DecodeManager {
    ...
    public void showPermissionDeniedDialog(Context context) {
        // 权限在安装时被关闭了，如小米手机
        new AlertDialog.Builder(context,R.style.custom_dialog).setTitle(R.string.qr_code_notification)
    ...
    public void showResultDialog(Activity activity, String resultString, DialogInterface.OnClickListener listener) {
        new AlertDialog.Builder(activity,R.style.custom_dialog).setTitle(R.string.qr_code_notification).setMessage(resultString)
