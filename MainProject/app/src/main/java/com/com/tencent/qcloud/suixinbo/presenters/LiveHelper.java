package com.com.tencent.qcloud.suixinbo.presenters;
    ...
    public void switchRoom(){
        ...
        ILVLiveManager.getInstance().switchRoom(CurLiveInfo.getRoomNum(), memberOption, new ILiveCallBack() {
            ...
            public void onError(String module, int errCode, String errMsg) {
                ...
                if (null != mLiveView) {
                    mLiveView.quiteRoomComplete(MySelfInfo.getInstance().getIdStatus(), true, null,errCode);
                }
            }
        });
    ...
    public void startExitRoom() {
        ILVLiveManager.getInstance().quitRoom(new ILiveCallBack() {
            ...
            public void onSuccess(Object data) {
                ...
                if (null != mLiveView) {
                    mLiveView.quiteRoomComplete(MySelfInfo.getInstance().getIdStatus(), true, null,0);
                }
            }
...
//    }
    ...
    private void joinRoom() {
        ILVLiveRoomOption memberOption = new ILVLiveRoomOption("")
                ...
                .videoMode(ILiveConstants.VIDEOMODE_BSUPPORT)
                .controlRole(Constants.NORMAL_MEMBER_ROLE)
                .imGroupId(CurLiveInfo.getChatRoomId())
                .authBits(AVRoomMulti.AUTH_BITS_JOIN_ROOM | AVRoomMulti.AUTH_BITS_RECV_AUDIO | AVRoomMulti.AUTH_BITS_RECV_CAMERA_VIDEO | AVRoomMulti.AUTH_BITS_RECV_SCREEN_VIDEO)
                .videoRecvMode(AVRoomMulti.VIDEO_RECV_MODE_SEMI_AUTO_RECV_CAMERA_VIDEO)
                .autoMic(false);
...
//                Toast.makeText(mContext,"加入房间失败:"+ module + "|" + errCode + "|" + errMsg,Toast.LENGTH_LONG).show();
                if (null != mLiveView) {
                    mLiveView.quiteRoomComplete(MySelfInfo.getInstance().getIdStatus(), true, null,errCode);
                }
            }
