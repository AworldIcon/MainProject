...
public class Alipay {
    ...
    public Alipay(Activity mActivity,String sign,PayStatusCallBack payCallBack){
        this.activity = mActivity;
        this.sign = sign;
        this.payStatusCallBack = payCallBack;
    }
...
//                        Toast.makeText(activity, "支付成功", Toast.LENGTH_SHORT).show();
                        payStatusCallBack.onAliPaySuccess(resultStatus);
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
//                        Toast.makeText(activity, "支付失败", Toast.LENGTH_SHORT).show();
                        payStatusCallBack.onAliPayFailure(resultStatus);
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
...
//        final String orderInfo = orderParam + "&" + sign;
        if (TextUtils.isEmpty(sign)) {
            ToastUtils.makeText(activity, "签名不能为空", Toast.LENGTH_SHORT).show();
            return;
        }
  ...
  public interface PayStatusCallBack {
        void onAliPaySuccess(String resultStatus);

        void onAliPayFailure(String resultStatus);
    }
